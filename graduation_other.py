# -*- coding: utf-8 -*-
"""graduation_other_ver3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1oyIjpkiS1s67Rq86EKKhHQEy04QVb7s_
...
recommender = GraduationRecommender()
...
# 추천 실행
try:
    recommendations = recommender.recommend(text=test_text, top_k=3)
    print("추천 결과:")
