...
class WeddingRecommendationSystem:
    def __init__(self, embedding_model='snunlp/KR-SBERT-V40K-klueNLI-augSTS',
                 tokenizer_model='kakaobrain/kogpt', model_name='kakaobrain/kogpt'):
        ...
        self.tokenizer = PreTrainedTokenizerFast.from_pretrained(tokenizer_model)
        self.text_generator = GPT2LMHeadModel.from_pretrained(model_name)
    ...
    def extract_keywords_from_text(self, user_input):
        ...
        output_ids = self.text_generator.generate(input_ids, max_length=50, num_beams=4, early_stopping=True)
